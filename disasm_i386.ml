...
module ToIR = struct
  ...
  let op2e_s mode ss has_rex t = function
    ...
    | Oreg r -> unimplemented mode "unknown register"
    ...
    | Oseg r -> disfailwith mode "Segment register when t is not r16"
  ...
  let assn_s mode s has_rex has_vex t v e =
    ...
    | Ovec r, Reg (256|128|64|32) ->
      let v = bits2ymm r in
      sub_assn t v e
    | Ovec r, _ -> disfailwith mode "invalid SIMD register size for assignment"
    ...
    | Oseg r, _ when t = r16 ->
      ...
      move v e
    | Oseg r, _ -> disfailwith mode "Can't assign to non 16 bit segment register"
