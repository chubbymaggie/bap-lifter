...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1aa5c60445424fd3236347a99497e00b) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Disasm_ARM"; "Disasm_i386"];
                      lib_pack = false;
                      lib_internal_modules = ["Arch_arm"; "Arch_i386"];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\023\189<*d\157\140z\177\165\001$\186\248\159\146";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
