...
(* OASIS_START *)
(* DO NOT EDIT (digest: bca3a736edfc51e7f491eab3a95e9840) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Arch_arm"; "Arch_i386"];
                      lib_pack = false;
                      lib_internal_modules = ["Disasm_ARM"; "Disasm_i386"];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "toil.ml"});
               Executable
                 ({
                     cs_name = "bapd";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "bapd.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\254j!\143\011\024c\225\187t\154\249K\178n=";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
